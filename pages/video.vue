...
<template>
	<view class="container">
		<view id="realVideo">
		    <hic-video-player
		        src="https://aaaabbb.oss-cn-beijing.aliyuncs.com/2323.mp4"
			...
			<view class="cssBox"style="position: relative;">
				...
				<view class="leftBox">
					<view class="margin-bottom-sm">
						<text class="text-bold text-xl">测试标题</text>
					</view>
					<view>
	...
	export default {
		...
		data() {
			return {
				list: [
				  {
				    src: 'https://bjetxgzv.cdn.bspapp.com/VKCEYUGU-hello-uniapp/1.mp3',
				    poster: 'https://bjetxgzv.cdn.bspapp.com/VKCEYUGU-uni-app-doc/1.png',
				    name: '致爱丽丝',
				    author: '路德维希·范·贝多芬'
				  },
				],
